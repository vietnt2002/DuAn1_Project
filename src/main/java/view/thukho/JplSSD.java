...
public class JplSSD extends javax.swing.JPanel {
    ...
    private final ISSDService svc = new SSDService() {
    };
    List<SSDView> lst = new ArrayList<>();
    ...
    public JplSSD() {
        initComponents();
        model = (DefaultTableModel) tblSSD.getModel();
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            SSDView mau = new SSDView(txtMa.getText(), txtTen.getText(), date, date, 0);
            int thongBao = svc.them(mau);
            if (thongBao == 1) {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try {
            ...
            SSDView mau = new SSDView(txtMa.getText(), txtTen.getText(), tao, sua, stt);
            int thongBao = svc.sua(mau);
            if (thongBao == 1) {
