...
public class FrmThuKho extends javax.swing.JFrame {
    ...
    List<MauSacView> lstMS = new ArrayList<>();
    private final ISanPhamService svcSP = new SanPhamService() {
    };
    List<SanPhamView> lstSP = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        pnlSPInfoLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel29, jLabel30, jLabel43, radCon5, radHet5});
        ...
        pnlSPInfoLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel29, jLabel30, jLabel43, radCon5, radHet5});
        ...
        pnlMauSacinfoLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel37, jLabel42, jLabel60, radCon4, radHet4});

        pnlMauSacinfoLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtMa4, txtTen4});
        ...
        pnlMauSacinfoLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel37, jLabel42, jLabel60, radCon4, radHet4});

        pnlMauSacinfoLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtMa4, txtTen4});
        ...
        tabKho.addTab("Màu sắc", pnlMauSac);
    ...
    private void btnAdd4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd4ActionPerformed
        ...
        try {
            ...
            MauSacView mau = new MauSacView(txtMa4.getText(), txtTen4.getText(), date, date, stt);
    ...
    private void btnEdit4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEdit4ActionPerformed
        ...
        try {
            ...
            int stt = (radHet4.isSelected() ? 1 : 0);
            MauSacView mau = new MauSacView(txtMa4.getText(), txtTen4.getText(), tao, date, stt);
    ...
    private void btnAdd5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd5ActionPerformed
        ...
        try {
            ...
            SanPhamView sp = new SanPhamView(txtMa5.getText(), txtTen5.getText(), date, date, stt);
    ...
    private void btnEdit5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEdit5ActionPerformed
        ...
        try {
            ...
            int stt = (radHet5.isSelected() ? 1 : 0);
            SanPhamView sp = new SanPhamView(txtMa5.getText(), txtTen5.getText(), tao, date, stt);
            int thongBao = svcSP.them(sp);
            if (thongBao == 1) {
                JOptionPane.showMessageDialog(this, "Sửa thành công!");
                filltableSP();
