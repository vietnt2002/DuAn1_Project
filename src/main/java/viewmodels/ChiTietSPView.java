...
public class ChiTietSPView {
    ...
    public String toString() {
        return "ChiTietSPView{" + "id=" + id + ", idSP=" + idSP + ", idNSX=" + idNSX + ", idMauSac=" + idMauSac + ", idDongSP=" + idDongSP + ", idCPU=" + idCPU + ", idRam=" + idRam + ", idSSD=" + idSSD + ", idManHinh=" + idManHinh + ", idChiTietHD=" + idChiTietHD + ", idBH=" + idBH + ", canNang=" + canNang + ", moTa=" + moTa + ", soLuongTon=" + soLuongTon + ", giaNhap=" + giaNhap + ", giaBan=" + giaBan + ", ngayTao=" + ngayTao + ", ngaySua=" + ngaySua + ", trangThai=" + trangThai + '}';
    }
